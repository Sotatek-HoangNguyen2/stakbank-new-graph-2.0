    ...
    var result = !ports
        ...
        : (function () {
            return ports.split(',').map(function (untypedPort) {
                ...
                var _b = exposedFragments.length === 2 ? exposedFragments[0].split(':') : [], address = _b[0], mappedPort = _b[1];
                return __assign({ exposed: { port: Number(port), protocol: protocol } }, (address &&
                    mappedPort && { mapped: { port: Number(mappedPort), address: address } }));
            });
        })();
    return result;
};
exports.mapPorts = mapPorts;
var mapPsOutput = function (output) {
    var services = output
        ...
        return {
            ...
            ports: exports.mapPorts(untypedPortsFragment.trim())
        };
    });
...
var rm = function (options) {
    ...
    return execCompose('rm', __spreadArray(['-f'], services), options);
};
exports.rm = rm;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, execCompose('config', [], options)];
                case 1:
                    result = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, execCompose('config', ['--services'], options)];
                case 1:
                    result = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, execCompose('config', ['--volumes'], options)];
                case 1:
                    result = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, execCompose('ps', [], options)];
                case 1:
                    result = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, execCompose('port', args, options)];
                case 2:
                    result = _b.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, execCompose('version', ['--short'], options)];
                case 1:
                    result = _a.sent();
